...
/// **Stable** — coefficient Poly w.r.t. var^exp
...
// **Pipeline private** — `is_univariate_in`
...
// **Pipeline private** — `main_var_for_gcd`
...
// **Pipeline private** — `rational_primitive`
...
// **Pipeline private** — `pseudo_rem_wrt`
...
// **Stable** — content w.r.t. main var
fn content_wrt(p: &Poly, var: &Var) -> Poly {
    content_wrt_impl(p, var)
}

// **Stable** — primitive part w.r.t. var
...
// **Pipeline private** — `gcd_constant_wrt`
...
// **Pipeline private** — `subresultant_gcd_wrt`
...
/// **Stable** — multivariate gcd subresultant
...
// **Pipeline private** — `scale_gcd_by_content`
