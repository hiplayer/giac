...
**giac-poly 分任务清单：** [GIAC-poly-algext-backlog](GIAC-poly-algext-backlog.md)（Phase 0–4、P2-3 partfrac、里程碑 M1–M4）。**gcd/factor 实施顺序：** [GIAC-poly-algext-gcd-factor-priority](../issues_resolved/GIAC-poly-algext-gcd-factor-priority.md)（T0–T3 ✅ resolved）。
