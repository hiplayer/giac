...
namespace xcas {
  ...
  public:
    ...
    int max_displayed; // max number of instructions displayed (2d)
  protected:
  ...
  int figure_param_dialog(Fl_Widget * f,bool adjust,double & tmin,double & tmax,double & tcurrent,double & tstep,std::string & name,bool symb,std::string & tmp,bool ispnt);
