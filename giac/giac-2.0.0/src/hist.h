...
#define Xcas_Unlocked_Numworks_menu (menu_Xcas_main_menu+38)
#define Xcas_nws_doc (menu_Xcas_main_menu+39)
#define Xcas_open_numworks_xws (menu_Xcas_main_menu+40)
#define Xcas_send_numworks_xws (menu_Xcas_main_menu+41)
#define Xcas_send_numworks_prog (menu_Xcas_main_menu+42)
#define Xcas_open_nws_calc (menu_Xcas_main_menu+43)
#define Xcas_Export_nws_calc (menu_Xcas_main_menu+44)
#define Xcas_nw_backup (menu_Xcas_main_menu+45)
#define Xcas_nw_restore (menu_Xcas_main_menu+46)
#define Xcas_Handle_nws_flash (menu_Xcas_main_menu+47)
#define Xcas_nw_install (menu_Xcas_main_menu+48)
#define Xcas_nw_update (menu_Xcas_main_menu+49)
#define Xcas_nw_alpha (menu_Xcas_main_menu+50)
#define Xcas_nw_rescue (menu_Xcas_main_menu+51)
#define Xcas_nw_certify_overwrite (menu_Xcas_main_menu+52)
#define Xcas_nnumworks_doc (menu_Xcas_main_menu+54)
#define Xcas_open_nnumworks_xws (menu_Xcas_main_menu+55)
#define Xcas_send_nnumworks_xws (menu_Xcas_main_menu+56)
#define Xcas_send_nnumworks_prog (menu_Xcas_main_menu+57)
#define Xcas_open_nnumworks_calc (menu_Xcas_main_menu+58)
#define Xcas_Export_nnumworks_calc (menu_Xcas_main_menu+59)
#define Xcas_nnumworks_backup (menu_Xcas_main_menu+60)
#define Xcas_nnumworks_restore (menu_Xcas_main_menu+61)
#define Xcas_Handle_nnumworks_flash (menu_Xcas_main_menu+62)
#define Xcas_nw_certify (menu_Xcas_main_menu+63)
#define Xcas_nnumworks_installb (menu_Xcas_main_menu+64)
#define Xcas_nnumworks_install (menu_Xcas_main_menu+65)
#define Xcas_Export (menu_Xcas_main_menu+67)
#define Xcas_Export_Khicas_TI83 (menu_Xcas_main_menu+68)
#define Xcas_Export_Khicas_Casio (menu_Xcas_main_menu+69)
#define Xcas_Export_Khicas_Numworks (menu_Xcas_main_menu+70)
#define Xcas_Export_Khicas_Nspire (menu_Xcas_main_menu+71)
#define Xcas_Export_nws (menu_Xcas_main_menu+72)
#define Xcas_Export_Xcas (menu_Xcas_main_menu+73)
#define Xcas_Export_XcasPy (menu_Xcas_main_menu+74)
#define Xcas_Export_Maple (menu_Xcas_main_menu+75)
#define Xcas_Export_Mupad (menu_Xcas_main_menu+76)
#define Xcas_Export_TI (menu_Xcas_main_menu+77)
#define Xcas_Close (menu_Xcas_main_menu+79)
#define Xcas_Print (menu_Xcas_main_menu+80)
#define Xcas_Print_Preview (menu_Xcas_main_menu+81)
#define Xcas_Print_Printer (menu_Xcas_main_menu+82)
#define Xcas_Print_Preview_Selected (menu_Xcas_main_menu+83)
#define Xcas_Print_Latex (menu_Xcas_main_menu+85)
#define Xcas_LaTeX_Print_Preview (menu_Xcas_main_menu+86)
#define Xcas_LaTeX_Print_Printer (menu_Xcas_main_menu+87)
#define Xcas_LaTeX_Print_Selection (menu_Xcas_main_menu+88)
#define Xcas_screen_capture (menu_Xcas_main_menu+90)
#define Xcas_do_nothing1 (menu_Xcas_main_menu+91)
#define Xcas_create_links (menu_Xcas_main_menu+92)
#define Xcas_quit_update (menu_Xcas_main_menu+93)
#define Xcas_do_nothing2 (menu_Xcas_main_menu+94)
#define Xcas_quit (menu_Xcas_main_menu+95)
#define Xcas_Edit (menu_Xcas_main_menu+97)
#define Xcas_Execute_Worksheet (menu_Xcas_main_menu+98)
#define Xcas_Execute_Worksheet_Delay (menu_Xcas_main_menu+99)
#define Xcas_Execute_Below (menu_Xcas_main_menu+100)
#define Xcas_Remove_Answers (menu_Xcas_main_menu+101)
#define Xcas_Undo (menu_Xcas_main_menu+102)
#define Xcas_Redo (menu_Xcas_main_menu+103)
#define Xcas_Copy (menu_Xcas_main_menu+104)
#define Xcas_Paste (menu_Xcas_main_menu+105)
#define Xcas_Delete (menu_Xcas_main_menu+106)
#define Xcas_Tex_Selection (menu_Xcas_main_menu+107)
#define Xcas_Add_Entry1 (menu_Xcas_main_menu+108)
#define Xcas_Add_Parameter (menu_Xcas_main_menu+109)
#define Xcas_Insert_Newline (menu_Xcas_main_menu+110)
#define Xcas_Merge (menu_Xcas_main_menu+111)
#define Xcas_Add_HF (menu_Xcas_main_menu+112)
#define Xcas_Fold (menu_Xcas_main_menu+113)
#define Xcas_Flatten (menu_Xcas_main_menu+114)
#define Xcas_main_configuration (menu_Xcas_main_menu+116)
#define Xcas_cas_config_ (menu_Xcas_main_menu+117)
#define Xcas_graph_config_ (menu_Xcas_main_menu+118)
#define Xcas_general_config_ (menu_Xcas_main_menu+119)
#define Xcas_config_program (menu_Xcas_main_menu+120)
#define Xcas_Set_Xcas0 (menu_Xcas_main_menu+121)
#define Xcas_Set_Python0 (menu_Xcas_main_menu+122)
#define Xcas_Set_Python0xor (menu_Xcas_main_menu+123)
#define Xcas_Set_Maple0 (menu_Xcas_main_menu+124)
#define Xcas_Set_Mupad0 (menu_Xcas_main_menu+125)
#define Xcas_Set_TI0 (menu_Xcas_main_menu+126)
#define Xcas_show_something (menu_Xcas_main_menu+128)
#define Xcas_show_DispG (menu_Xcas_main_menu+129)
#define Xcas_show_keyboard (menu_Xcas_main_menu+130)
#define Xcas_show_bandeau (menu_Xcas_main_menu+131)
#define Xcas_show_msg (menu_Xcas_main_menu+132)
#define Xcas_show_script_window (menu_Xcas_main_menu+133)
#define Xcas_warn_program_sto_on (menu_Xcas_main_menu+134)
#define Xcas_Hide_Something (menu_Xcas_main_menu+136)
#define Xcas_hide_DispG (menu_Xcas_main_menu+137)
#define Xcas_hide_keyboard (menu_Xcas_main_menu+138)
#define Xcas_hide_bandeau (menu_Xcas_main_menu+139)
#define Xcas_hide_msg (menu_Xcas_main_menu+140)
#define Xcas_warn_program_sto_off (menu_Xcas_main_menu+141)
